<?php
	...
	class WP_MANGA_RECENT extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			global $wp_manga_functions, $wp_manga_template;
			...
			$number_chapters    = ! empty( $instance['number_chapters'] ) ? $instance['number_chapters'] : '2';
            ...
            <div class="c-widget-content <?php echo esc_attr($style); ?> <?php echo $button != '' ? 'with-button' : ''; ?>">
				<?php
					if ( $title != '' ) {
					...
					$widget_setting_number_chapters = $number_chapters;
		...
		function update( $new_instance, $old_instance ) {
			...
			$instance['number_chapters']            = strip_tags( $new_instance['number_chapters'] );
		...
		function form( $instance ) {
			...
			$artist  = ! empty( $instance['artist'] ) ? $instance['artist'] : '';
			$release = ! empty( $instance['release'] ) ? $instance['release'] : '';
			$number_chapters = ! empty( $instance['number_chapters'] ) ? $instance['number_chapters'] : '';
			...
			<p>
                <label for="<?php echo $this->get_field_id( 'number_chapters' ); ?>"><?php echo esc_html__( 'Number of Chapters', WP_MANGA_TEXTDOMAIN ); ?>
                    : </label>
                <select class="widefat" id="<?php echo $this->get_field_id( 'number_chapters' ); ?>" name="<?php echo $this->get_field_name( 'number_chapters' ); ?>">
                    <option value="0" <?php echo $number_chapters == '0' ? 'selected' : '' ?>><?php echo esc_html__( 'Hidden', WP_MANGA_TEXTDOMAIN ); ?></option>
					<option value="1" <?php echo $number_chapters == '1' ? 'selected' : '' ?>><?php echo esc_html__( '1', WP_MANGA_TEXTDOMAIN ); ?></option>
					<option value="2" <?php echo $number_chapters == '2' ? 'selected' : '' ?>><?php echo esc_html__( '2', WP_MANGA_TEXTDOMAIN ); ?></option>
					<option value="3" <?php echo $number_chapters == '3' ? 'selected' : '' ?>><?php echo esc_html__( '3', WP_MANGA_TEXTDOMAIN ); ?></option>
					<option value="4" <?php echo $number_chapters == '4' ? 'selected' : '' ?>><?php echo esc_html__( '4', WP_MANGA_TEXTDOMAIN ); ?></option>
                </select>
            </p>
