...
<div id="init-links" class="nav-links">
	...
	if(!$has_current_reading){
		...
		if($sort_order == 'asc'){
			?>
			<a href="<?php echo $first_link;?>" id="btn-read-first" class="c-btn c-btn_style-1">
			<?php esc_html_e('Read First', 'madara');?></a>
			<a href="<?php echo $last_link;?>" id="btn-read-last" class="c-btn c-btn_style-1"><?php esc_html_e('Read Last', 'madara');?></a>
			<?php
		} else {
			?>
			<a href="<?php echo $last_link;?>" id="btn-read-last" class="c-btn c-btn_style-1">
			<?php esc_html_e('Read First', 'madara');?></a>
			<a href="<?php echo $first_link;?>" id="btn-read-first" class="c-btn c-btn_style-1"><?php esc_html_e('Read Last', 'madara');?></a>
			<?php
		}
	}?>
</div>
