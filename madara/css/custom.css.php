	...
	function madara_custom_CSS()
	{
		...
		if ($header_bottom_custom_colors == 'on' || (is_page() && $front_page_header_bottom_colors == 'on')) {
			...
			if ($front_page_header_bottom_colors == 'off') {
				...
				$bottom_nav_sub_item_hover_color = $madara->getOption('sbottom_nav_sub_item_hover_color', '');
		...
		if ($main_color != '') {
			...
			$custom_css .= ':root{ --primary-color: ' . $main_color . '}';
			
			if ($main_color_end != '') {
				$custom_css .= ':root{ --secondary-color: ' . $main_color_end . '}';
			...
			$custom_css .= '.c-search-header__wrapper .search-content .btn-search-adv.collapsed{background-color:'. $main_color . '; color:#FFF}.c-search-header__wrapper .search-content .btn-search-adv{color:#FFF}';
			...
			$custom_css .= '.page-item-detail.video .item-thumb > a:hover, .page-item-detail.video .item-thumb:hover a:hover:before{color:' . $main_color . '}';
		...
		if ($hot_badges_bg_color != '') {
			$custom_css .= '.manga-title-badges.hot, body.page .c-page-content .c-page .c-page__content .page-content-listing .page-listing-item .page-item-detail .item-summary .manga-title-badges.hot { background-color: ' . $hot_badges_bg_color . ' ;}';
		}

		if ($new_badges_bg_color != '') {
			$custom_css .= '.manga-title-badges.new, body.page .c-page-content .c-page .c-page__content .page-content-listing .page-listing-item .page-item-detail .item-summary .manga-title-badges.new { background-color: ' . $new_badges_bg_color . ' ;}';
		}

		if ($custom_badges_bg_color != '') {
			$custom_css .= '.manga-title-badges.custom, .manga-title-badges.custom { background-color: ' . $custom_badges_bg_color . ' ;}';
		}
...
body.manga-page .profile-manga .tab-summary .post-rating .post-total-rating i.ion-ios-star-half { color: ' . $star_color . ' ;}';
		...
		if ($header_bottom_bg != '') {
			$custom_css .= 'body.text-ui-light .site-header .c-sub-header-nav, body.text-ui-dark .site-header .c-sub-header-nav { background-color: ' . $header_bottom_bg . ' ;}';
		}
		...
		if ($btn_bg != '') {
			...
			$custom_css .= '.c-btn.c-btn_style-2, .c-search-header__wrapper .search-content .btn-search-adv.collapsed, .c-search-header__wrapper .search-content .btn-search-adv, .genres_wrap a.btn-genres { border-color : ' . $btn_bg . ' ;}';
			$custom_css .= '.c-btn.c-btn_style-2, .c-search-header__wrapper .search-content .btn-search-adv, .genres_wrap a.btn-genres { color : ' . $btn_bg . ' ;}';
		}
		...
		if ($btn_hover_bg != '') {
			...
			$custom_css .= '.c-btn.c-btn_style-2:hover, .c-search-header__wrapper .search-content .btn-search-adv:hover, .c-search-header__wrapper .search-content .btn-search-adv.collapsed:hover, .genres_wrap a.btn-genres:hover { border-color : ' . $btn_hover_bg . ' ;}';
		}
		...
		$single_forecolor = $madara->getOption('manga_profile_forecolor', '');
		if($single_forecolor != ''){
			$custom_css .= 'body.manga-page .profile-manga .post-title h1, .profile-manga .c-breadcrumb .breadcrumb li a, body.text-ui-light .profile-manga h5, body.text-ui-dark .profile-manga h5,body.text-ui-light.manga-page .profile-manga .tab-summary .post-rating span,body.text-ui-dark.manga-page .profile-manga .tab-summary .post-rating span{color:' . $single_forecolor . '}';
		}
