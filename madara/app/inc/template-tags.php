<?php
	...
	function madara_manga_title_badges_html( $post_id, $echo = 0 ) {
		$manga_badge_style = Madara::getOption('manga_badge_style', 'round');
		...
		if ( ! empty( $manga_adult_content ) && $manga_adult_content[0] == 'yes' ) {
			$badges_html .= '<span class="manga-title-badges custom adult badge-' . $manga_badge_style . '"><span class="text">';
		...
		if($badges != 'no'){
			if ( $badges == 'custom' ) {
				...
				if ( $custom_badges != '' ) {
					$badges_html .= '<span class="manga-title-badges custom badge-' . $manga_badge_style . ' ' . esc_attr(sanitize_title($custom_badges)) . '"><span class="text">';
					$badges_html .= esc_html( $custom_badges );
					$badges_html .= '</span></span>';
				}
			} else {
				$badges_html .= '<span class="manga-title-badges ' . $badges . ' badge-' . $manga_badge_style . '"><span class="text">';
